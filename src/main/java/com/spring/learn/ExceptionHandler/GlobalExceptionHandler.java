package com.spring.learn.ExceptionHandler;
...
import com.spring.learn.pojo.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> duplicateValueFoundExceptionHandler(DuplicateValueFoundException ex)
    {
        String message=ex.getMessage();
        ApiResponse apiResponse=new ApiResponse(message,false);
